        ...
        <div className="h-full">
            <div className="h-full relative">
                ...
                >
                    ...
                    <button className="absolute top-24 gap-1 items-center text-bold text-white w-16 h-16 text-white flex justify-center items-center font-medium text-lg hidden xl:flex" onClick={homeHandler}>
