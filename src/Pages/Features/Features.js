    ...
    return (
        <div className="h-full">
            <div className="h-full relative">
                ...
                >
                    <button className="absolute top-1/3 left-1/2 transform -translate-x-1/2 flex-col items-center text-bold text-white w-16 h-16 rounded-full bg-rose-700 bg-opacity-70 text-white flex justify-center items-center hidden lg:flex">
                    ...
                    <button className="absolute top-24 gap-1 items-center text-bold text-white w-16 h-16 text-white flex justify-center items-center font-medium text-lg hidden lg:flex" onClick={homeHandler}>
